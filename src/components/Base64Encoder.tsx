...
function Base64Encoder({ onBack }: Base64EncoderProps) {
  ...
  const handleProcess = async () => {
    ...
    try {
      const endpoint = operation === 'encode'
        ? 'http://localhost:8080/api/devtools/base64-encode'
        : 'http://localhost:8080/api/devtools/base64-decode'
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-2">Base64 인코딩 및 디코딩</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="flex-1 max-w-6xl mx-auto px-6 py-8 w-full">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow">
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
              <h2 className="font-semibold text-gray-900">
                {operation === 'encode' ? '원본 텍스트' : 'Base64 텍스트'}
              </h2>
            ...
            <textarea
              ...
              placeholder={operation === 'encode' ? '인코딩할 텍스트를 입력하세요' : '디코딩할 Base64 텍스트를 입력하세요'}
          ...
          <div className="bg-white rounded-lg shadow">
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
              <h2 className="font-semibold text-gray-900">
                {operation === 'encode' ? 'Base64 결과' : '디코딩 결과'}
              </h2>
              {output && (
                <button
                  onClick={handleCopy}
